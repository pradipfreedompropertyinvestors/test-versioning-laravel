    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Sub District Management</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-end my-3">
                        <div class="col-md-8">
                            <div class="dt-buttons btn-group mb-3">
                                <button class="btn btn-primary waves-effect waves-light" type="button" id="add-sub-district"><i class="mdi mdi-account-plus-outline mr-2"></i><span>Add New</span></button>
                            </div>
                        </div>
                        <div class="col-md-2">
                    ...
                    <table id="subdistrictsTable" class="table table-striped dt-responsive nowrap">
